      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10">
        <Reveal>
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-12">
            ...
            <Link
              href="/articles"
              className="inline-flex items-center gap-2 rounded-full border border-line-light text-ink-900 font-semibold px-5 py-2.5 text-sm hover:bg-white hover:text-ink-900 transition-colors self-start"
            >
              All articles
