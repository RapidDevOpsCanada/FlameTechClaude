...
const airdrieLinks = [
  ...
  { label: "AC Repair", href: "/air-conditioning-repair-airdrie/" },
  ...
  { label: "Water Heater Repair", href: "/water-heater-repair-airdrie/" },
  { label: "Poly-B Replacement", href: "/polyb-plumbing-airdrie/" },
  { label: "Sump Pump Install", href: "/sump-pump-installation-airdrie/" },
...
const serviceAreas: { label: string; href: string }[] = [
  ...
  { label: "Brentwood", href: "/brentwood-plumbers-calgary/" },
  { label: "Hillhurst", href: "/hillhurst-plumbers-calgary/" },
    ...
    <footer className="bg-ink-900 text-cream-50 border-t border-line-dark">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10 py-16 grid grid-cols-2 md:grid-cols-6 gap-10">
        ...
        <div className="col-span-2 md:col-span-2">
          ...
          <p className="text-cream-50/75 leading-relaxed text-[16px] max-w-xs mb-6">
      ...
      <div className="border-t border-line-dark">
        <div className="max-w-7xl mx-auto px-6 md:px-10 py-10">
          <h5 className="text-[14px] font-bold uppercase tracking-[0.18em] text-primary mb-5">
            Airdrie Services
          </h5>
          <ul className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-x-6 gap-y-3">
            {airdrieLinks.map((item) => (
              <li key={item.href}>
                <Link
                  href={item.href}
                  className="text-[16px] text-cream-50/80 hover:text-emergency transition-colors"
                >
                  {item.label}
                </Link>
              </li>
