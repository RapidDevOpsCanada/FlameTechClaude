...
export const services: ServicePage[] = [
      ...
      sections: [
        {
          ...
          intro:
            "From emergency calls in established neighbourhoods to full renovations in new builds, our Calgary plumbing specialists have seen every bathroom configuration this city has to offer.\n\nWe've been fixing bathroom plumbing across Calgary for over two decades — from the original galvanized steel in [Mount Royal](/mount-royal-plumbers-calgary/) character homes to the builder-grade fixtures failing in 2010-era developments. Our technicians carry parts for every major brand, understand Calgary's hard water issues, and know exactly what goes wrong with the cheap vanity faucets and [shower valves](/shower-plumbing-calgary/) builders love to install.\n\nWhen [Poly-B supply lines](/polyb-plumbing-calgary/) burst behind bathroom walls or when that 15-year-old toilet finally gives up, our [emergency plumber](/emergency-plumber-calgary/) team gets there fast with the right parts and tools.",
          items: [
      ...
      sections: [
        {
          ...
          intro:
            "From emergency shower repairs to complete bathroom renovations, our Calgary plumbing crew knows what actually works in Alberta homes.\n\nWe've installed and repaired thousands of showers across Calgary, from basic builder-grade setups in [Panorama Hills](/panorama-hills-plumbers-calgary/) to high-end steam showers in [Aspen Woods](/aspen-woods-plumbers-calgary/). Our technicians are certified in pressure-balancing valve installation, know the quirks of every major shower valve manufacturer, and understand how Calgary's hard water affects different fixtures — a [water softener](/water-softener/) upstream extends cartridge life noticeably.\n\nWhen you call FlameTech, you're getting plumbers who've seen it all — [Poly-B supply lines](/polyb-plumbing-calgary/) that split during chinooks, mixing valves that fail after 15 years, and tile jobs that leak because the contractor didn't waterproof properly. Same crew handles [bathroom plumbing](/bathroom-plumbing-calgary/) end-to-end.",
          items: [
  ...
  },
  {
    ...
    heroBadgeImage: { src: "/images/REVIEWS1.png", alt: "5-star Google rated" },
    heroImage: { src: "/images/FTVAN2.jpg", alt: "FlameTech service van — drain cleaning across Calgary", fit: "cover", position: "top" },
    intro:
  ...
  },
  {
    ...
    sidebar: {
      ...
      subtitle:
        "Burst pipes, sewer backups, major leaks — priority dispatch from licensed plumbers and gas fitters with 20+ years in Calgary.",
      bullets: [
    ...
    richContent: {
      ...
      faq: {
        ...
        items: [
          ...
          { q: "Are your emergency plumbers licensed and insured?", a: "Yes — every tech on the truck is licensed, bonded, and insured to work across Alberta. We meet all Alberta plumbing codes and Calgary permit requirements. Insurance certificate available on request before we start work." },
        ],
      },
    },
  },
  {
    ...
    heroBody: [
      "If your Calgary home was built between 1978 and 1995, there's a strong chance it contains polybutylene piping — a material now recognised for premature deterioration and sudden failures that threaten property and disrupt lives.",
      "FlameTech specialises in identifying Poly-B systems across Calgary neighbourhoods like [Mahogany](/mahogany-plumbers-calgary/), [Tuscany](/tuscany-plumbers-calgary/), [Evergreen](/evergreen-plumbers-calgary/), and [Edgemont](/edgemont-plumbers-calgary/), assessing condition, and executing full replacement with modern PEX or copper that insurance carriers accept and homebuyers expect.",
      "Don't wait for catastrophic pipe failure. Proactive replacement protects your investment, maintains insurance coverage, and delivers peace of mind that your plumbing won't betray you at the worst possible moment. If a fitting has already let go, our [emergency plumber](/emergency-plumber-calgary/) team will be there same-day.",
    ],
    heroSubhead: "Calgary's Poly-B Replacement Experts",
    heroBadgeImage: { src: "/images/REVIEWS1.png", alt: "5-star Google rated" },
    heroImage: { src: "/images/FTVAN2.jpg", alt: "FlameTech plumbing service van — Poly-B replacement specialists in Calgary", fit: "cover" },
    intro:
    ...
    richContent: {
      sections: [
        {
          ...
          intro:
            "Thousands of Calgary homes built during the 1980s-90s construction boom contain Poly-B plumbing that ages poorly and fails without warning. Unlike gradual deterioration you'd notice, polybutylene pipes can look perfectly fine one day and rupture catastrophically the next.\n\nFlameTech understands the specific challenges facing Calgary homeowners with polybutylene. We provide honest assessments of your piping condition, explain insurance implications clearly, and deliver efficient whole-home repiping that minimises disruption while maximising long-term reliability.\n\nOur replacement installations meet current Alberta building codes, use materials approved by every major insurance carrier, and come backed by manufacturer warranties that protect your investment for decades. If you'd rather spread the cost out, [Financeit monthly payments](/financing/) are available on full re-pipes.",
          items: [
        ...
        },
        {
          ...
          intro:
            "Polybutylene's widespread failure comes from chemical reactions between the plastic and common water-treatment additives — chlorine and chloramine, both present in Calgary's municipal supply.\n\nGradual degradation weakens pipe walls from the inside out, creating brittle sections prone to sudden cracking, pinhole leaks, and complete ruptures that flood homes without warning.\n\nCalgary's temperature extremes accelerate the damage. Freeze-thaw cycles stress already-compromised material, and the hard water that [a water softener](/water-softener/) would address otherwise compounds the chemical wear over time.",
          items: [
      ...
      faq: {
        ...
        items: [
          { q: "How do I know if my Calgary home has Poly-B plumbing?", a: "Polybutylene pipes look like flexible grey (sometimes white) plastic tubing, typically stamped with \"PB2110\" markings along their length.\n\nCheck visible plumbing beneath sinks, around water heaters, and in basement mechanical rooms. If your Calgary home was built between 1978 and 1995, there's a substantial chance Poly-B is somewhere in the system.\n\nCommon locations include the main water supply line entering the house, distribution pipes running through walls and ceilings, and connections to fixtures throughout the home. The plastic fittings on Poly-B often use metal crimp rings or compression joints that look noticeably different from standard copper connections.\n\nIf you're uncertain, we provide free inspections to identify the material and assess its current condition." },
          { q: "Should I proactively replace Poly-B pipes before they fail?", a: "Proactive replacement offers real advantages over waiting for catastrophic failure. Poly-B deteriorates unpredictably — one section might last decades while another fails tomorrow, making it impossible to predict when disaster will strike.\n\nEmergency repairs after a pipe burst cost substantially more than a planned replacement once you add water-damage remediation, rushed service calls, and temporary housing if the home becomes uninhabitable. Our [emergency plumber](/emergency-plumber-calgary/) team handles these calls, but it's never the cheap path.\n\nInsurance complications worsen with age. Carriers increasingly refuse coverage or demand replacement as a condition of policy renewal. Property value suffers since informed buyers recognise Poly-B as a major liability and either demand a price reduction or walk away.\n\nScheduled replacement lets you choose timing that fits your budget, avoid emergency stress, and install superior modern materials with manufacturer warranties. [Financeit monthly payments](/financing/) are available if cashflow is the constraint." },
          { q: "Will my insurance cover Poly-B damage or replacement?", a: "Insurance coverage for polybutylene failures varies dramatically between providers and specific policy language.\n\nMany Calgary insurers now exclude Poly-B-related claims entirely, refuse new policies on homes with known polybutylene systems, or demand immediate replacement as a condition of continued coverage. Some carriers provide limited coverage for sudden failures but exclude gradual leaks or damage from known-defective materials.\n\nReview your specific policy carefully and contact your insurance provider directly about Poly-B coverage. Many homeowners discover exclusions only after filing claims following catastrophic failures.\n\nDocumentation of regular maintenance and prompt repairs strengthens coverage arguments, but replacement remains the only guaranteed solution. FlameTech provides detailed insurance-grade documentation following all Poly-B work." },
          { q: "How much does Poly-B replacement cost in Calgary?", a: "Complete Poly-B replacement costs depend on home size, accessibility of existing pipes, chosen replacement material, and extent of drywall repair required.\n\nTypical Calgary homes range from basic replacements in smaller properties with exposed plumbing to extensive repiping in larger multi-storey homes requiring significant wall access. PEX installations generally cost less than copper while providing excellent performance and freeze resistance suited to Calgary's climate. Partial replacements focused on high-risk areas cost substantially less but leave vulnerable sections that may fail later.\n\nWe provide detailed written estimates after a thorough home assessment, explain every cost factor transparently, and offer [Financeit monthly payments](/financing/) for qualified homeowners.\n\nMany Calgary residents find replacement costs comparable to a premium insurance deductible plus water-damage repairs following just one major Poly-B failure." },
          { q: "What's the best replacement material for Poly-B — PEX or copper?", a: "PEX (cross-linked polyethylene) is the optimal replacement material for most Calgary homes. It offers excellent freeze resistance, flexibility that simplifies installation through existing walls, resistance to corrosion and scale buildup, and cost-effectiveness compared to copper.\n\nModern PEX carries manufacturer warranties of 25-50 years, requires fewer fittings (reducing potential leak points), and performs reliably in Calgary's temperature extremes.\n\nCopper remains preferred for specific applications including exposed piping where aesthetics matter and situations requiring maximum heat resistance.\n\nBoth materials satisfy building codes, meet insurance requirements, and provide dramatic improvements over polybutylene. FlameTech assesses your specific home — water hardness, existing access, budget — to recommend the right material for your situation." },
        ],
      },
    },
  },
      ...
      sections: [
        {
          ...
          intro:
            "Locally owned and operated in Calgary, we specialise in professional boiler repair for homes and businesses across the city. Technical expertise separates professional boiler repair from guesswork, and FlameTech's team brings decades of specialised knowledge to every service call.\n\nCalgary's challenging climate — extreme temperature swings, chinook winds that stress heating systems — requires technicians who understand how weather patterns affect boiler performance. Our team has troubleshot thousands of boiler failures across every Calgary neighbourhood from Kensington to [McKenzie Towne](/mckenzie-towne-plumbers-calgary/).\n\nNeed a full system instead? See [boiler installation](/boiler-installation-calgary/), or read about our [annual boiler service](/boiler-service-calgary/) program to prevent future failures.",
          items: [
      ...
      faq: {
        ...
        items: [
          ...
          },
          {
            ...
            a: "For most no-heat calls during business hours, yes. Priority emergency dispatch covers Calgary, Airdrie, Chestermere, Cochrane, and Okotoks. Call us first — we'll confirm a window before the truck leaves the shop.",
          },
        ],
      },
    },
  ...
  },
  {
    ...
    beforeAfter: {
      ...
      intro:
        "Real Calgary furnace replacements — old atmospheric units pulled and replaced with high-efficiency AirEase furnaces, new venting, and clean piping. Drag the slider on each to compare.",
      pairs: [
        {
...

  {
    ...
    heroBadgeImage: { src: "/images/REVIEWS1.png", alt: "5-star Google rated" },
    heroImage: { src: "/images/FTVAN2.jpg", alt: "FlameTech plumbing service van in Airdrie", fit: "cover" },
    intro:
...

  {
    ...
    callout:
      "Tank leaking or water gone cold? Call 587-834-3668 — our Calgary trucks are stocked with 40 and 50 gallon tanks and dispatch up the QEII into every Airdrie community.",
    richContent: {
      sections: [
        {
      ...
      faq: {
        ...
        items: [
          ...
          },
          {
            ...
            a: "Yes — priority dispatch covers every Airdrie community, including Coopers Crossing, Ravenswood, and Reunion. We carry the most common 40 and 50 gallon tanks on the truck so a same-day swap is usually possible.",
          },
        ],
      },
    },
...

  {
    ...
    heroBadgeImage: { src: "/images/REVIEWS1.png", alt: "5-star Google rated" },
    heroImage: { src: "/images/FTVAN2.jpg", alt: "FlameTech plumbing service van in Ravenswood, Airdrie", fit: "cover" },
    intro:
    ...
    richContent: {
      sections: [
        {
          heading: "Plumbing Services for Ravenswood",
          items: [
      ...
      faq: {
        ...
        items: [
          ...
          { q: "Which plumbing services does FlameTech offer in Ravenswood?", a: "Drain cleaning, water heater service and replacement, leak detection, pipe repair and replacement, fixture installation, sewer line work, and bathroom/kitchen renovations. If it carries water or gas, we work on it." },
          { q: "Are your technicians licensed and insured?", a: "Yes. Every tech is licensed, bonded, and insured to work across Alberta. Insurance certificate available on request before we start." },
...

  {
    ...
    heroBadgeImage: { src: "/images/REVIEWS1.png", alt: "5-star Google rated" },
    heroImage: { src: "/images/FTVAN2.jpg", alt: "FlameTech plumbing service van in Reunion, Airdrie", fit: "cover" },
    intro:
    ...
    richContent: {
      sections: [
        {
          heading: "Plumbing Services for Reunion Properties",
          items: [
      ...
      faq: {
        ...
        items: [
          ...
          { q: "Are all your plumbers licensed and insured?", a: "Yes. Every tech is licensed, bonded, and insured to work across Alberta. Insurance certificate available on request before we start." },
...

  {
    ...
    heroBadgeImage: { src: "/images/REVIEWS1.png", alt: "5-star Google rated" },
    heroImage: { src: "/images/FTVAN2.jpg", alt: "FlameTech plumbing service van in Bowness", fit: "cover" },
    intro:
...

  {
    ...
    heroBadgeImage: { src: "/images/REVIEWS1.png", alt: "5-star Google rated" },
    heroImage: { src: "/images/FTVAN2.jpg", alt: "FlameTech plumbing service van in Bridlewood", fit: "cover" },
    intro:
...

  {
    ...
    heroBadgeImage: { src: "/images/REVIEWS1.png", alt: "5-star Google rated" },
    heroImage: { src: "/images/FTVAN2.jpg", alt: "FlameTech plumbing service van in Northwest Calgary", fit: "cover" },
    intro:
    ...
    sidebar: {
      ...
      subtitle:
        "Plumbing service across every Northwest Calgary community — priority emergency dispatch, honest pricing.",
      bullets: [
        "Licensed, insured, and bonded",
      ...
      faq: {
        ...
        items: [
          ...
          },
          {
            ...
            a: "Priority emergency response, drain and sewer work, water heater installation and repair, leak detection, pipe repair and replacement, fixture installation, bathroom and kitchen renovations, scheduled maintenance, and water treatment. If it carries water or gas, we work on it.",
          },
          {
  ...
  // --- from nb-entries-B.ts ---
  {
    ...
    heroBadgeImage: { src: "/images/REVIEWS1.png", alt: "5-star Google rated" },
    heroImage: { src: "/images/FTVAN2.jpg", alt: "FlameTech plumbing service van in Southeast Calgary", fit: "cover" },
    intro:
      ...
      faq: {
        ...
        items: [
          ...
          },
          {
            ...
            a: "Priority emergency response, [drain cleaning](/drain-cleaning-calgary/) and sewer work, [water heater installation](/hot-water-tanks/) and repair, leak detection, pipe repair and replacement, fixture installation, [bathroom](/bathroom-plumbing-calgary/) and kitchen renovations, scheduled maintenance, and water treatment. We handle residential and commercial across Southeast Calgary.",
          },
          {
...

  {
    ...
    heroBadgeImage: { src: "/images/REVIEWS1.png", alt: "5-star Google rated" },
    heroImage: { src: "/images/FTVAN2.jpg", alt: "FlameTech plumbing service van in Southwest Calgary", fit: "cover" },
    intro:
...

  {
    ...
    heroBadgeImage: { src: "/images/REVIEWS1.png", alt: "5-star Google rated" },
    heroImage: { src: "/images/FTVAN2.jpg", alt: "FlameTech plumbing service van in Chaparral", fit: "cover" },
    intro:
      ...
      sections: [
        {
          ...
          intro:
            "Our Southeast Calgary plumbing team has been fixing pipes and water heaters in Chaparral since the first homes were built.\n\nMost Chaparral homes were built with standard builder-grade plumbing that's now showing its age — we've replaced dozens of original [hot water tanks](/hot-water-tanks/) that finally gave up after 15+ years of Calgary's hard water. A [water softener](/water-softener/) upstream stretches the next tank's life considerably.\n\nThe newer sections near Chaparral Valley Way have different challenges than the original development near 194 Avenue, and our experienced SE Calgary crew knows exactly what to expect when we pull up to your driveway.",
          items: [
        ...
        },
        {
          ...
          intro:
            "Our Calgary plumbers work and live in the SE. Chaparral sits in a natural valley, which means basement moisture issues and foundation settling that affects plumbing connections.\n\nMost homes here have identical builder-grade plumbing systems that are now hitting their failure point simultaneously — we've replaced more [hot water tanks](/hot-water-tanks/) in Chaparral in the past two years than any other SE Calgary community.\n\nWe also serve neighbouring [Cranston](/cranston-plumber-calgary/), [Auburn Bay](/auburn-bay-plumber-calgary/), and [McKenzie Lake](/mckenzie-lake-plumbers-calgary/).",
        },
      ],
      faq: {
        heading: "Frequently Asked Questions",
...

  {
    ...
    heroBadgeImage: { src: "/images/REVIEWS1.png", alt: "5-star Google rated" },
    heroImage: { src: "/images/FTVAN2.jpg", alt: "FlameTech plumbing service van in Edgemont", fit: "cover" },
    intro:
      ...
      sections: [
        {
          ...
          intro:
            "Locally owned and operated in NW Calgary, we understand the unique challenges Edgemont properties face. Edgemont sits on higher ground in northwest Calgary, but that doesn't mean you're immune to plumbing problems.\n\nThe older homes here often have original fixtures and water lines due for updates, and the newer builds sometimes have builder-grade components failing earlier than expected.\n\nWe also serve neighbouring [Tuscany](/tuscany-plumbers-calgary/), [Varsity](/varsity-plumbers-calgary/), [Evanston](/evanston-plumbers-calgary/), and [Panorama Hills](/panorama-hills-plumbers-calgary/).",
          items: [
        ...
        },
        {
          ...
          intro:
            "Our Calgary plumbers work and live in the NW, which means we understand Edgemont's unique challenges — from the original 1990s plumbing reaching end-of-life to the elevation changes that cause drainage issues in some areas.\n\nMost Edgemont homes were built during Calgary's growth boom, so we see a mix of quality levels depending on the builder and year. Whether you've got [Poly-B piping](/polyb-plumbing-calgary/) that needs replacing or builder-grade fixtures failing early, we've seen it all.\n\nAlberta's extreme weather puts extra stress on plumbing systems, and Calgary's building codes have evolved significantly since the 1990s. Same crew covers neighbouring [Tuscany](/tuscany-plumbers-calgary/) and [Varsity](/varsity-plumbers-calgary/).",
        },
      ],
      faq: {
        heading: "Frequently Asked Questions",
  ...
  // --- from nb-entries-C.ts ---
  {
    ...
    heroBadgeImage: { src: "/images/REVIEWS1.png", alt: "5-star Google rated" },
    heroImage: { src: "/images/FTVAN2.jpg", alt: "FlameTech plumbing service van in Evanston", fit: "cover" },
    intro:
      ...
      faq: {
        ...
        items: [
          ...
          },
          {
            ...
            a: "Yes — We handle warranty work on new construction plumbing and know the common issues with current builder-grade fixtures and systems. Many of the furnaces and water heaters in new Evanston homes are basic models that we service regularly throughout NW Calgary.",
          },
        ],
      },
    },
...

  {
    ...
    heroBadgeImage: { src: "/images/REVIEWS1.png", alt: "5-star Google rated" },
    heroImage: { src: "/images/FTVAN2.jpg", alt: "FlameTech plumbing service van in Evergreen", fit: "cover" },
    intro:
    ...
    sidebar: {
      ...
      subtitle:
        "Plumbing for SW Calgary's Evergreen community — priority dispatch, modern equipment, family-friendly service.",
      bullets: [
      ...
      faq: {
        ...
        items: [
          ...
          },
          {
            ...
            a: "Drain cleaning, water heater repair and installation, leak detection, pipe repair and replacement, fixture installation, sewer line work, and bathroom/kitchen renovations. Residential and commercial — anything that carries water or gas in an Evergreen property.",
          },
          {
            q: "Are your plumbers licensed and insured?",
            a: "Yes. Every tech is licensed, bonded, and insured to work across Alberta. Insurance certificate available on request before we start.",
...

  {
    ...
    heroBadgeImage: { src: "/images/REVIEWS1.png", alt: "5-star Google rated" },
    heroImage: { src: "/images/FTVAN2.jpg", alt: "FlameTech plumbing service van in Huntington Hills", fit: "cover" },
    intro:
      ...
      faq: {
        ...
        items: [
          ...
          },
          {
            ...
            a: "Burst pipes and sewer backups get priority routing over scheduled work. We dispatch from Calgary up Centre St or Deerfoot into Huntington Hills, and we know which routes hold up during rush hour or bad weather. Call 587-834-3668 and we'll confirm a window before the truck rolls.",
          },
          {
...

  {
    ...
    heroBadgeImage: { src: "/images/REVIEWS1.png", alt: "5-star Google rated" },
    heroImage: { src: "/images/FTVAN2.jpg", alt: "FlameTech plumbing service van in Marda Loop", fit: "cover" },
    intro:
...

  {
    ...
    heroBadgeImage: { src: "/images/REVIEWS1.png", alt: "5-star Google rated" },
    heroImage: { src: "/images/FTVAN2.jpg", alt: "FlameTech plumbing service van in McKenzie Towne", fit: "cover" },
    intro:
...

  {
    ...
    heroBadgeImage: { src: "/images/REVIEWS1.png", alt: "5-star Google rated" },
    heroImage: { src: "/images/FTVAN2.jpg", alt: "FlameTech plumbing service van in New Brighton", fit: "cover" },
    intro:
...

  {
    ...
    heroBadgeImage: { src: "/images/REVIEWS1.png", alt: "5-star Google rated" },
    heroImage: { src: "/images/FTVAN2.jpg", alt: "FlameTech plumbing service van in Signal Hill", fit: "cover" },
    intro:
    ...
    richContent: {
      ...
      faq: {
        ...
        items: [
          ...
          { q: "Are you familiar with hillside drainage systems?", a: "Yes — We're experienced with Signal Hill's infrastructure specific to 1980s through modern luxury homes, familiar with hillside drainage systems, and understand the unique requirements of Signal Hill's elevated topography." },
...

  {
    ...
    heroBadgeImage: { src: "/images/REVIEWS1.png", alt: "5-star Google rated" },
    heroImage: { src: "/images/FTVAN2.jpg", alt: "FlameTech plumbing service van in Varsity", fit: "cover" },
    intro:
...

  {
    ...
    heroBadgeImage: { src: "/images/REVIEWS1.png", alt: "5-star Google rated" },
    heroImage: { src: "/images/FTVAN2.jpg", alt: "FlameTech plumbing service van in West Springs", fit: "cover" },
    intro:
      ...
      faq: {
        ...
        items: [
          ...
          },
          {
            ...
            a: "Drain cleaning, water heater service and installation, leak detection, pipe repair and replacement, fixture installation, sewer line work, and [bathroom](/bathroom-plumbing-calgary/) and kitchen renovations. If it carries water or gas in a West Springs home, we work on it.",
          },
          {
            q: "Are your plumbers licensed and insured?",
            a: "Yes. Every tech is licensed, bonded, and insured to work across Alberta. Insurance certificate available on request before we start.",
    ...
    richContent: {
      sections: [
        ...
        },
        {
          heading: "Local SW Calgary Expertise",
          intro:
            "Our plumbers work and live in the SW, which means we understand the plumbing systems in older character homes common to [Mount Royal](/mount-royal-plumbers-calgary/) and Elbow Park, the infrastructure challenges in 1970s and 1980s developments throughout nearby areas, and modern plumbing in new SW Calgary communities.\n\nWe know how Calgary's freeze-thaw cycles specifically affect SW properties, and we stay current on all local building codes and permit requirements.\n\nSimilar experience across [Signal Hill](/signal-hill-plumbers-calgary/), [Evergreen](/evergreen-plumbers-calgary/), and [Altadore](/altadore-plumbers-calgary/) helps us diagnose faster on the first visit.",
        },
      ],
      faq: {
        heading: "Frequently Asked Questions",
...

  {
    ...
    heroBadgeImage: { src: "/images/REVIEWS1.png", alt: "5-star Google rated" },
    heroImage: { src: "/images/FTVAN2.jpg", alt: "FlameTech plumbing service van in Coopers Crossing", fit: "cover" },
    intro:
    ...
    richContent: {
      sections: [
        {
          heading: "Plumbing Services in Coopers Crossing",
          intro:
    ...
    richContent: {
      ...
      faq: {
        ...
        items: [
          ...
          { q: "How long does an AirEase furnace installation take?", a: "Most standard AirEase furnace installations in Calgary homes complete within one full day (6-10 hours).\n\nStraightforward replacements where existing ductwork, venting, and electrical connections remain compatible finish faster. More complex projects requiring ductwork modifications, new thermostat wiring, [humidifier integration](/humidifiers-calgary/), or venting upgrades may extend into a second day.\n\nWe perform comprehensive load calculations before installation, inspect all existing components for compatibility, and complete thorough testing of safety systems, combustion efficiency, and airflow balance." },
...

  {
    ...
    heroBadgeImage: { src: "/images/REVIEWS1.png", alt: "5-star Google rated" },
    heroImage: { src: "/images/FTVAN2.jpg", alt: "FlameTech plumbing service van — Chestermere coverage", fit: "cover", position: "top" },
    intro:
    ...
    bullets: [
      { t: "Quick dispatch from Calgary", d: "Trucks roll east on 17 Ave or Glenmore directly into Chestermere — straightforward access on either route, emergency calls get priority routing." },
      { t: "Lakefront property experience", d: "Homes along Chestermere Lake have higher water tables, sump-pump dependence, and shoreline irrigation tie-ins. We've worked the patterns across Lakeside Greens, East Chestermere, and Sunset Cove." },
      { t: "Kinniburgh + Rainbow Falls modern stock", d: "Newer east-side communities (Kinniburgh, Clearwater Park) are mostly post-2010 PEX builds — modern systems but the high-efficiency tankless and boiler installs are now hitting first-service windows." },
      { t: "Licensed & insured", d: "Alberta-licensed plumbers and gas fitters. Full liability coverage protecting your property." },
      { t: "Hard-water aware", d: "Same hard mineral profile as east Calgary. We size and spec for the actual mineral load, not against a generic baseline." },
    ],
      ...
      sections: [
        {
          ...
          items: [
            ...
            { heading: "Sump pumps + lake-side drainage", body: "Higher water tables along the lake mean sump pumps work harder. We install primary + battery-backup pumps, troubleshoot float-switch failures, and assess weeping-tile tie-ins on lakefront and lake-view builds." },
        ...
        {
          heading: "Why Chestermere plumbing is different from Calgary",
          intro:
            "Chestermere isn't just east-Calgary suburb. The man-made lake, the irrigation-canal heritage, and the rapid 2000s-2010s growth all change what we run into on service calls.",
          items: [
            { heading: "Chestermere Lake = higher water table", body: "Properties within a few blocks of the lake have noticeably higher groundwater. Sump pumps run more often, weeping tile fails sooner, and basement bathroom installs often need ejector pumps where Calgary's drier ground wouldn't. We've seen what works and what doesn't on Lakeside Greens and Sunset Cove." },
            { heading: "Lakefront irrigation + dock plumbing", body: "Lakefront homes often have outdoor irrigation tied to lake water, separate shoreline shutoffs, and dock hose-bib runs that need winterizing. Standard Calgary winterization checklists miss these — we know which valves to find and where they live." },
            { heading: "Irrigation-canal heritage", body: "Chestermere grew up around the Western Irrigation District canal system. Older town-water hookups can have unusual layouts. Rare now but worth knowing about when something doesn't match the plans." },
            { heading: "Two build eras with two different problems", body: "Lake-area properties (1980s-90s) have Poly-B and aging galvanized — same problems we see in McKenzie Lake or Mahogany. East-side communities (Kinniburgh, Clearwater Park, Rainbow Falls — mostly 2010+) are modern PEX and high-efficiency systems now hitting first-service age (10-15 years on tankless, boiler, and furnace equipment)." },
            { heading: "Town water with high mineral load", body: "City of Chestermere supply runs hard — similar profile to east Calgary, but homes here often have older water heaters scaling up faster than expected. A properly-sized softener pays back in fixture and water-heater life within 4-5 years." },
            { heading: "Cold-snap exposure across open prairie", body: "Chestermere sits on open prairie east of Calgary — wind exposure is higher, and outdoor hose bibs + exposed garage piping freeze faster during extended cold snaps. Frost-free sillcocks are worth the upgrade." },
          ],
        },
      ],
      faq: {
        ...
        items: [
          { q: "Do you dispatch to Chestermere for emergencies?", a: "Yes — Chestermere is on our regular dispatch radius. Emergency calls get priority routing over scheduled work. Call 587-834-3668 and we'll confirm a window before the truck rolls east on 17 Ave or Glenmore." },
...

  {
    ...
    heroBadgeImage: { src: "/images/REVIEWS1.png", alt: "5-star Google rated" },
    heroImage: { src: "/images/FTVAN2.jpg", alt: "FlameTech plumbing service van — Cochrane coverage", fit: "cover" },
    intro:
    ...
    richContent: {
      sections: [
        {
          ...
          items: [
            ...
            { heading: "Drain cleaning + sewer camera", body: "Hydro-jetting and camera inspection for slow drains and full backups. Mature trees on Riverview and downtown lots send roots into older clay laterals. See [drain cleaning Calgary](/drain-cleaning-calgary/)." },
          ],
        },
        {
          heading: "Why Cochrane plumbing is different from Calgary",
          intro:
            "Cochrane isn't a Calgary suburb — different water source, real elevation changes within town, big acreage component, and a heritage downtown that's older than most of Calgary's housing stock.",
          items: [
      ...
      faq: {
        ...
        items: [
          { q: "How does dispatch to Cochrane work?", a: "We dispatch from Calgary west on Highway 1A — direct route into Cochrane via Hwy 22 or the Bow valley. Emergency calls receive priority routing over scheduled work. Call 587-834-3668 and we'll confirm a window before the truck rolls." },
          { q: "Do you do well-water work in Cochrane?", a: "Yes — we install and service softeners, filtration (iron + manganese), pressure tanks, and pump-side plumbing on Cochrane acreage properties. Bearspaw and Cochrane Lake area properties typically need more aggressive treatment than newer in-town builds. Bring us a recent water test (or we can take one) and we'll spec the right system." },
          { q: "Why is water pressure so different across town?", a: "Cochrane's elevation drops several hundred feet from Sunset Ridge / Heritage Hills down to the Bow valley floor. High-elevation homes often have static pressure pushing or exceeding the 80 PSI limit that fixture warranties cover — a pressure-reducing valve protects everything downstream. Valley-floor properties sometimes need booster pumps. We measure before specifying." },
          { q: "Do you service the older downtown stock?", a: "Yes — galvanized supply lines, cast-iron stacks, original clay laterals on the pre-1980 homes around 4th Avenue and the original townsite. Same heritage approach we use in Calgary's Mount Royal: preserve the finished interior, target the actual failure, document for future work." },
          { q: "Can you handle the new Riversong + Fireside builds?", a: "Yes — modern PEX plumbing and high-efficiency boilers, tankless heaters, and furnaces are all in scope. The 10-15 year mark on these systems is when first-service replacements start coming up, and we see that window regularly across both communities." },
...

  {
    ...
    heroBadgeImage: { src: "/images/REVIEWS1.png", alt: "5-star Google rated" },
    heroImage: { src: "/images/FTVAN2.jpg", alt: "FlameTech plumbing service van — Okotoks coverage", fit: "cover" },
    intro:
...

  {
    ...
    heroBadgeImage: { src: "/images/REVIEWS1.png", alt: "5-star Google rated" },
    heroImage: { src: "/images/FTVAN2.jpg", alt: "FlameTech plumbing service van — Carstairs coverage", fit: "cover", position: "top" },
    intro:
    ...
    bullets: [
      { t: "Acreage + well-water experience", d: "Most Carstairs properties run on well water with high mineral and iron levels. We test, size softener and filtration, and spec pressure tanks for the actual conditions — not generic numbers." },
      ...
      sections: [
        {
          ...
          items: [
            ...
            { heading: "Septic system in-home work", body: "Most rural Carstairs properties are on septic. We don't pump tanks but we diagnose backups, replace failed lift and ejector pumps, and rebuild drain stacks, vent integrity, and below-grade fixture connections." },
        ...
        {
          heading: "Why Carstairs plumbing is different from Calgary or Airdrie",
          intro:
          ...
          items: [
            ...
            { heading: "Longer freeze exposure on outdoor + barn plumbing", body: "Rural acreage has outdoor hose bibs, barn lines, and outbuilding plumbing that's more exposed to extended cold than a Calgary suburban yard. Frost-free sillcocks, heat trace on vulnerable runs, and proper winterization all matter more here." },
            { heading: "Newer subdivisions inside town are modern PEX", body: "Recent Carstairs subdivisions (Mountain View, North Acres) are post-2000 PEX-plumbed builds with high-efficiency systems — same modern setup we see in Calgary's newer communities. The original water heaters and furnaces in these homes are now hitting first-replacement age." },
          ],
        },
      ],
      faq: {
