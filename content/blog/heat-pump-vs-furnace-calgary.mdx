...
Calgary natural gas is cheap per unit of heat. Electricity is not. That one fact drives everything below, and it's why heat pump marketing written for Ontario or BC doesn't translate here.

For a typical 2,000 sq ft Calgary home with average insulation, ranked cheapest to run:

1. **Hybrid** — the cheapest to operate, by a clear margin.
2. **Heat-pump-only** (cold-climate, properly sized) — in the middle.
3. **Furnace-only** — the most expensive to run, though not by as much as you'd expect, precisely because our gas is so cheap.

The hybrid wins because it runs the heat pump at mild temperatures — which is most of the heating season — and reserves the furnace for the 4-6 weeks when we dip below -15°C. That's the regime where a heat-pump-only system falls back on auxiliary resistance heat, which is the single most expensive way there is to heat a Calgary house.

What you'd actually pay depends on your gas and power rates, your insulation, and how you run the thermostat. We'd rather work that out against your real utility bills than publish an average that fits nobody.

## Upfront cost

Ranked cheapest to most expensive:

1. **Furnace replacement (90% AFUE)** — the baseline, and the cheapest way to keep a Calgary house warm.
2. **High-efficiency furnace (97-98% AFUE)** — a step up in price that earns it back over a long heating season.
3. **Cold-climate heat pump** (replaces your AC and supplements the furnace) — meaningfully more than a furnace, but it's doing two jobs, heating and cooling.
4. **Full hybrid system** (new furnace + new heat pump) — the most expensive, and the worst case if you're replacing both at once.

If your existing furnace has 5+ years of life left, adding just a heat pump on top costs a good deal less than a full hybrid — you're only buying half the system.

We quote all of these on-site and in writing, at no charge. A number pulled off a web page is a number that changes the moment we've seen your ducts, your gas line, and your electrical panel.

## Alberta rebates — what they actually do

Both federal Canada Greener Homes programs have now closed to new applicants — the [interest-free Loan](https://natural-resources.canada.ca/energy-efficiency/homes/canada-greener-homes-initiative) stopped taking applications on 1 October 2025 and the Grant closed on 20 January 2026. Anyone already approved keeps their funding. The one federal program still paying out is Oil to Heat Pump Affordability, and it only applies to homes moving off oil heat — which is rare in gas-heated Calgary.
...
**The air feels cooler, and that's normal.** A heat pump delivers air around 32–43°C against a furnace's 49–60°C, so it can warm the house while feeling neutral on your hand. It catches nearly everyone switching over — see [heat pump not warming the house](/blog/heat-pump-not-warming-house/) for what's normal and what isn't.
